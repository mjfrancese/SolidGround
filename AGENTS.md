...
Issue #12 approved the Phase 2 conventions below on 2026-09-20; `docs/architecture/revit-add-in-conventions.md` records the full the owner's other add-in basis, citations, and the 14 items still needing Revit 2027 verification (Issue #13). The agent must follow these rules for `SolidGround.Revit`:
