...
documents (roughly 10 cm vertical RMSE in favorable conditions, worse under mature canopy such as the Robandee
Lane fixture). A low `MeanRemovedElevationResidual` means the retained points reproduce the *simplified* surface's
