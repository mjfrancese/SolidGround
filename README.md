...
CLI. It does not yet attach Extensible Storage provenance to the created element; that is Issue #16. See
[the Revit add-in host scaffold note](docs/architecture/revit-add-in-host-scaffold.md) and
