...
{
    private const string GoldenBaseName = "example-site-synthetic";
    ...
    public async Task TheRealParcelPipelineIsDeterministicAcrossTwoRunsRoundTripsAndExcludesTheNodataHoleCellFromTheOriginalPointCount()
    {
        ...
        // example-site-synthetic.asc has exactly one true NODATA cell (its declared NODATA_value) among the grid's
    ...
    {
        string prjWkt = ReadFixture("example-site-synthetic.prj");
        ...
        using StringReader ascReader = new(ReadFixture("example-site-synthetic.asc"));
    ...
    private static async Task<TerrainExportBundle> RunRealParcelPipelineAsync(FixtureContext fixture, CancellationToken cancellationToken)
    {
        ...
        // example-site-synthetic-parcel.geojson and example-site-synthetic.asc are independently authored synthetic
