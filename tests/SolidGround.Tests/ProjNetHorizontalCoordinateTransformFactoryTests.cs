...
public sealed class ProjNetHorizontalCoordinateTransformFactoryTests
{
    ...
    {
        string fixtureWkt = ReadFixture("robandee-synthetic.prj");
    ...
    [Fact]
    public void CreateBuildsATransformWithTheCorrectDefinitionForWgs84ToTheRobandeeFixture()
    {
        string fixtureWkt = ReadFixture("robandee-synthetic.prj");
    ...
    [Fact]
    public void ForwardTransformsTheRobandeeCentroidToItsMeasuredUtmCoordinate()
    {
        IHorizontalCoordinateTransform transform = CreateFixtureTransform();

        Coordinate2D result = transform.Forward(new Coordinate2D(-90.477652, 38.700186));
        ...
        Assert.Equal(719348.901035d, result.X, 6);
        Assert.Equal(4286526.679525d, result.Y, 6);
    }
    ...
    public void ForwardAgreesWithAnIndependentProjEngineReferenceValue()
    {
        ...
        const double projEasting = 719348.9011552825d;
        const double projNorthing = 4286526.675106941d;
    ...
    public void InverseRecoversTheGeographicCoordinateOfAUtmPoint()
    {
        ...
        Coordinate2D result = transform.Inverse(new Coordinate2D(719385d, 4286527.554625536d));

        Assert.Equal(-90.4772369857d, result.X, 6);
        Assert.Equal(38.7001850040d, result.Y, 6);
    }

    [Theory]
    [InlineData(719385d, 4286527.554625536d)]
    [InlineData(719415d, 4286527.554625536d)]
    [InlineData(719415d, 4286572.445374464d)]
    [InlineData(719385d, 4286572.445374464d)]
    [InlineData(719347d, 4286525d)]
    [InlineData(719350d, 4286528d)]
    ...
    [Theory]
    [InlineData(-90.477652d, 38.700186d)]
    [InlineData(-90.477824432d, 38.699983807d)]
    [InlineData(-90.477479568d, 38.700388193d)]
    ...
    {
        IHorizontalCoordinateTransform transform = CreateFixtureTransform();
        Coordinate2D input = new(-90.477652, 38.700186);
    ...
    public void CreatesATransformAndLocalFrameThatTogetherSatisfyTerrainProvenancesInvariants()
    {
        ...
        LocalCoordinateFrame frame = new(new Coordinate3D(719347d, 4286525d, 183d), transform.Definition.TargetReference, vertical, LengthUnit.UsSurveyFoot);
    ...
    private static IHorizontalCoordinateTransform CreateFixtureTransform() =>
        ProjNetHorizontalCoordinateTransformFactory.Create(ProjNetHorizontalCoordinateTransformFactory.Wgs84WellKnownText, ReadFixture("robandee-synthetic.prj"));
