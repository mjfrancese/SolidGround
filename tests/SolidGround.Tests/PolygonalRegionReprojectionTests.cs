...
public sealed class PolygonalRegionReprojectionTests
{
    ...
    [Fact]
    public void ReprojectsTheRealRobandeeGeojsonParcelForwardThenInverseRoundTripsToItsOriginalWgs84Vertices()
    {
        ...
        // compares against the independently-authored robandee-synthetic-parcel.wkt fixture (which the
