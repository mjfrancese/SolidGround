...
{
    private static readonly Coordinate2D FixtureUtmPoint = new(719385d, 4286527.554625536d);
    private static readonly Coordinate2D FixtureLonLatPoint = new(-90.477652d, 38.700186d);
    ...
    {
        // Arrange: the real Robandee WGS 84 parcel fixture, and the real ProjNET-backed transform this issue
        // builds from Wgs84WellKnownText to the robandee-synthetic.prj fixture (geographic source, projected
        // target -- Create's own fixed orientation).
        string wgs84GeoJsonText = ReadFixture("robandee-synthetic-parcel.geojson");
        ...
        // ... and is not absurdly large: each side under 0.01 degrees for this ~1,346 m^2 lot (roughly 30 m by
        // 45 m) plus the 2 m buffer used above.
    ...
    // UTM point (719385, 4286527.554625536) does not throw at the ProjNET layer at all -- it silently returns
